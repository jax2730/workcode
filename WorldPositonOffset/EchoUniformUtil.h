...
namespace Echo
{
	...
	enum ECHO_UNIFORM_NAME_ID
	{
		...
		U_LightCount,        //material param8
		U_LightPower,        //material param9
		U_LightWorldPosiArray,  //material param10
		U_LightAttenuationArray, // //material param11
		U_LightDiffuseColorArray, //material param12

		U_ClusterLightParam, // ScreenSize clusterBlockSize
		U_ClusterLightID,	 // uint4
		U_ClusterLightWorldPosArray,
		U_ClusterLightDiffuseColorArray,
		U_ClusterLightDeltaSquareRadiusINVArray,
...
#define registerUniformNameID(key)  \
	...
	m_UniformIDToName[key] = #key;
		...
		static void init()
		{
			...
			registerUniformNameID(U_CameraPosition);
		...
		registerUniformNameID(U_InvTransposeWorldMatrix);
			...
			registerUniformNameID(U_LightCount);
			registerUniformNameID(U_LightPower);
			registerUniformNameID(U_LightWorldPosiArray);
			registerUniformNameID(U_LightAttenuationArray);
			registerUniformNameID(U_LightDiffuseColorArray);

			registerUniformNameID(U_ClusterLightParam);
			registerUniformNameID(U_ClusterLightID);
			registerUniformNameID(U_ClusterLightWorldPosArray);
			registerUniformNameID(U_ClusterLightDiffuseColorArray);
			registerUniformNameID(U_ClusterLightDeltaSquareRadiusINVArray);
