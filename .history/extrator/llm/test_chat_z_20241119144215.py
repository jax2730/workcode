...
workflow.add_conditional_edges("info", get_state,["add_tool_message", "info", "recheck", END])
workflow.add_conditional_edges("add_tool_message", get_state,["info", "recheck", END])
